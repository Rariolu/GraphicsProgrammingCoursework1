...
GameObject::GameObject(string meshName, string shaderName, string textureName) : GameObject(rescManager->GetMesh(meshName),(GameObjectShader*)rescManager->GetShader(shaderName), rescManager->GetModelTexture(textureName))
{
